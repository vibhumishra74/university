...
<header class="site-header">
      <div class="container">
        ...
        <?php  } else { ?>
           ...
           <a href="<?php echo esc_url(site_url('/wp-signup.php')) ?>" class="btn btn--small btn--dark-orange float-left">Sign Up</a>  <!--  // wp_registration_url(); in place of  esc_url(site_url('/wp-signup.php')) -->
          <?php } ?>
